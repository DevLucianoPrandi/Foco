        ...
        <Container fluid style={{ maxWidth: '1400px' }}>
            <Row className="mx-5">
                <Col className=" justify-content-center">
                    <h3 style={{ color: "#d8972f", marginBottom: "1rem" }}>Registro de Proyectos - Nivel inicial</h3>
                    ...
                    <p><span style={{ fontWeight: "600" }}>Nivel Inicial:</span> Sabrina Masini<br /></p>
            ...
            <Row className="formCarga">
                <Col>
                    <Form onSubmit={formik.handleSubmit}>
                        ...
                        <Form.Label style={{ fontSize: "1.2rem", fontWeight: "600", color: "#00618b" }}>Salas</Form.Label>
                        {renderCheckboxes("salas", ["Sala de 2", "Sala de 3", "Sala de 4", "Sala de 5"], formik)}

                        <hr />

                        <Form.Label style={{ fontSize: "1.2rem", fontWeight: "600", color: "#00618b" }}>Nivel involucrado</Form.Label>
                        {renderCheckboxes("nivelInvolucrado", ["Primaria", "Secundaria"], formik)}
